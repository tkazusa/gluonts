...
from ._base import Trainer, check_loss_finite, loss_value
...
class CustomTrainer(Trainer):
    ...
    def __init__(
        ...
        timewise_weight: Optional[List[float]] = None,
        ) -> None:
            ...
            def loop(  # todo call run epoch
                ...
                for batch_no, batch in enumerate(it, start=1):
                    ...
                    with mx.autograd.record():
                        ...
                        # TODO: 変更した
                        if timewise_weight:
                            assert len(timewise_weight) == loss.shape[1], "Length of the timewise weight is not same as prediction length"
                            from mxnet import nd
                            
                            weights_array = nd.array(timewise_weight * batch_size).reshape(batch_size, loss.shape[1])
                            loss = loss * weights_array
                            # TODO: Loss 
                            # print("Loss:", loss)
                            # print("Timewise Weighted Loss:", timewise_weighted_loss)


                            # TODO: 人手で変更変更する
                            # weight = True
                            # use_weighted_loss_for_metric = True
                            # print("="*40 + " weight =  " + str(weight) + " for metric = " + str(use_weighted_loss_for_metric) + "="*40) 
            ...
            try:
                for epoch_no in range(self.epochs):
                    ...
                    epoch_loss = loop(
                        ...
                        timewise_weight=self.timewise_weight
                    )
